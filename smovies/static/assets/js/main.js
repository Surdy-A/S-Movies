$(document).ready(function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        let sliderRating = document.getElementById("slider__rating");
        let ratingInput = document.getElementById("form__slider-value");

        if (sliderRating) {
            sliderRating.addEventListener("input", function () {
                ratingInput.value = sliderRating.value;
            });
        }
    });
	...
	document.addEventListener("DOMContentLoaded", function () {
		document.querySelectorAll(".like-button").forEach(button => {
			button.addEventListener("click", function () {
				...
				if (!likeCountSpan) {
					console.error("Like count span not found for comment:", commentId);
					return;
				}
				...
				.then(data => {
					if (data.likes !== undefined) {
						likeCountSpan.innerHTML = data.likes;  // ✅ Only update if element exists
					}
				})
				.catch(error => {
